...
public class InstrumentedTest {
    ...
    public void deleteReunionTest() throws InterruptedException {
        ViewInteraction textView = onView(allOf(withId(R.id.item_list_name), withText("Réunion A - 19H0 - Mario"), withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))), isDisplayed()));
        textView.check(matches(withText("Réunion A - 19H0 - Mario")));

        onView(withId(R.id.list_reunion_recyclerview)).perform(RecyclerViewActions.actionOnItemAtPosition(0, new DeleteViewAction()));

        Thread.sleep(1000); //wait to delete Reunion

        textView = onView(allOf(withId(R.id.item_list_name), withText("Réunion A - 19H0 - Mario"), withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))), isDisplayed()));
    ...
    public void deleteReunionWithFiltreDateTest() throws InterruptedException {
        ...
        ViewInteraction textView = onView(allOf(withId(R.id.item_list_name), withText("Réunion C - 19H0 - Luigi"), withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))), isDisplayed()));
        ...
        textView = onView(allOf(withId(R.id.item_list_name), withText("Réunion C - 19H0 - Luigi"), withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))), isDisplayed()));
        textView.check(doesNotExist());

        overflowMenuButton = onView(allOf(withContentDescription("More options"), childAtPosition(childAtPosition(withId(androidx.appcompat.R.id.action_bar), 1), 0), isDisplayed()));
        overflowMenuButton.perform(click());

        appCompatTextView = onView(allOf(withId(androidx.transition.R.id.title), withText("Reset du filtre"), childAtPosition(childAtPosition(withId(androidx.appcompat.R.id.content), 0), 0), isDisplayed()));
        appCompatTextView.perform(click());
    ...
    public void deleteReunionWithFiltreSalleTest() throws InterruptedException {
        ...
        ViewInteraction textView = onView(allOf(withId(R.id.item_list_name), withText("Réunion B - 19H0 - Mario"), withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))), isDisplayed()));
        ...
        textView = onView(allOf(withId(R.id.item_list_name), withText("Réunion B - 19H0 - Mario"), withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))), isDisplayed()));
        textView.check(doesNotExist());
    ...
    public void createReunionAndDeleteThisReunionTest() throws InterruptedException {
        ...
        //test
        ViewInteraction textView = onView(allOf(withId(R.id.item_list_name), withText("ReunionTest2 - 15H0 - Luigi"), withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))), isDisplayed()));
        ...
        textView = onView(allOf(withId(R.id.item_list_name), withText("ReunionTest2 - 15H0 - Luigi"), withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))), isDisplayed()));
        textView.check(doesNotExist());
    ...
    @Test
    public void createReunionAndCheckNameSalleEmailHourInListTest() throws InterruptedException {
        ViewInteraction floatingActionButton = onView(allOf(withId(R.id.floatingActionButton_AddReunion), withContentDescription("Ajoute une Réunion"), childAtPosition(childAtPosition(withId(android.R.id.content), 0), 1), isDisplayed()));
        floatingActionButton.perform(click());
        ...
        //test
        ViewInteraction textView = onView(allOf(withId(R.id.item_list_name), withText("ReunionTest3 - 16H0 - Luigi"), withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))), isDisplayed()));
        textView.check(matches(withText("ReunionTest3 - 16H0 - Luigi")));

        ViewInteraction textView1 = onView(allOf(withId(R.id.item_list_email), withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))), isDisplayed()));
    ...
    @Test
    public void checkBackInCreateViewTest() {
        ViewInteraction floatingActionButton = onView(allOf(withId(R.id.floatingActionButton_AddReunion), withContentDescription("Ajoute une Réunion"), childAtPosition(childAtPosition(withId(android.R.id.content), 0), 1), isDisplayed()));
        floatingActionButton.perform(click());

        ViewInteraction appCompatImageButton = onView(allOf(withContentDescription("Navigate up"), childAtPosition(allOf(withId(androidx.appcompat.R.id.action_bar), childAtPosition(withId(androidx.appcompat.R.id.action_bar_container), 0)), 1), isDisplayed()));
        appCompatImageButton.perform(click());

        //test
        ViewInteraction recyclerView = onView(allOf(withId(R.id.list_reunion_recyclerview), withParent(withParent(withId(android.R.id.content))), isDisplayed()));
        recyclerView.check(matches(isDisplayed()));
    }

    //Vérification l'affichage de la page création
    @Test
    public void checkIfCreateViewIsExistTest() {
        ViewInteraction floatingActionButton = onView(allOf(withId(R.id.floatingActionButton_AddReunion), withContentDescription("Ajoute une Réunion"), childAtPosition(childAtPosition(withId(android.R.id.content), 0), 1), isDisplayed()));
        floatingActionButton.perform(click());

        ViewInteraction viewGroup = onView(allOf(withId(R.id.constraintLayout_CreateReunion), withParent(withParent(withId(android.R.id.content))), isDisplayed()));
    ...
    @Test
    public void checkAllNameOfMenuFilterTest() {
        ViewInteraction overflowMenuButton = onView(allOf(withContentDescription("More options"), childAtPosition(childAtPosition(withId(androidx.appcompat.R.id.action_bar), 1), 0), isDisplayed()));
        overflowMenuButton.perform(click());

        ViewInteraction textView = onView(allOf(withId(androidx.core.R.id.title), withText("Filtrer par date"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView.check(matches(withText("Filtrer par date")));

        ViewInteraction textView2 = onView(allOf(withId(androidx.core.R.id.title), withText("Reset du filtre"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView2.check(matches(withText("Reset du filtre")));

        ViewInteraction textView3 = onView(allOf(withId(androidx.core.R.id.title), withText("Filtrer par lieu"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView3.check(matches(withText("Filtrer par lieu")));

        ViewInteraction appCompatTextView = onView(allOf(withId(androidx.core.R.id.title), withText("Filtrer par lieu"), childAtPosition(childAtPosition(withId(androidx.appcompat.R.id.content), 0), 0), isDisplayed()));
        appCompatTextView.perform(click());

        ViewInteraction textView4 = onView(allOf(withId(androidx.core.R.id.title), withText("Mario"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView4.check(matches(withText("Mario")));

        ViewInteraction textView5 = onView(allOf(withId(androidx.core.R.id.title), withText("Luigi"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView5.check(matches(withText("Luigi")));

        ViewInteraction textView6 = onView(allOf(withId(androidx.core.R.id.title), withText("Peach"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView6.check(matches(withText("Peach")));

        ViewInteraction textView7 = onView(allOf(withId(androidx.core.R.id.title), withText("Toad"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView7.check(matches(withText("Toad")));

        ViewInteraction textView8 = onView(allOf(withId(androidx.core.R.id.title), withText("Daisy"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView8.check(matches(withText("Daisy")));

        ViewInteraction textView9 = onView(allOf(withId(androidx.core.R.id.title), withText("Harmonie"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView9.check(matches(withText("Harmonie")));

        ViewInteraction textView10 = onView(allOf(withId(androidx.core.R.id.title), withText("Wario"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView10.check(matches(withText("Wario")));

        ViewInteraction textView11 = onView(allOf(withId(androidx.core.R.id.title), withText("Waluigi"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView11.check(matches(withText("Waluigi")));

        ViewInteraction textView12 = onView(allOf(withId(androidx.core.R.id.title), withText("Yoshi"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView12.check(matches(withText("Yoshi")));

        ViewInteraction textView13 = onView(allOf(withId(androidx.core.R.id.title), withText("Bowser"), withParent(withParent(withId(androidx.appcompat.R.id.content))), isDisplayed()));
        textView13.check(matches(withText("Bowser")));
    }

    //vérification que la date du datepicker et la date renseigné dans le textView est identique
    @Test
    public void DatePickerCreateViewTest() {
        ViewInteraction floatingActionButton = onView(allOf(withId(R.id.floatingActionButton_AddReunion), withContentDescription("Ajoute une Réunion"), childAtPosition(childAtPosition(withId(android.R.id.content), 0), 1), isDisplayed()));
        floatingActionButton.perform(click());
        ...
        ViewInteraction editText = onView(allOf(withId(R.id.textInput_Date), withText("25/1/2024"), withParent(withParent(withId(R.id.outlinedTextField_Date))), isDisplayed()));
        editText.check(matches(withText("25/1/2024")));

    }

    //vérification que l'heure du timepicker et l'heure renseigné dans le textView heureStart est identique
    @Test
    public void testTimePickerStart() {
        ...
        ViewInteraction editText = onView(allOf(withId(R.id.textInput_Duree_start), withText("16H0"), withParent(withParent(withId(R.id.outlinedTextField_Duree_start))), isDisplayed()));
        editText.check(matches(withText("16H0")));

    }

    //vérification que l'heure du timepicker et l'heure renseigné dans le textView heureEnd est identique
    @Test
    public void testTimePickerEnd() {
        ...
        ViewInteraction editText2 = onView(allOf(withId(R.id.textInput_Duree_end), withText("17H30"), withParent(withParent(withId(R.id.outlinedTextField_Duree_end))), isDisplayed()));
        editText2.check(matches(withText("17H30")));
